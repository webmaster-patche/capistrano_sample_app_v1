Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "capistrano_sample_app_v1_#{Rails.env}"
  ...
  # entry = logging.entry
  # entry.log_name = "capistrano_sample_app_v1_#{Rails.env}_log"
  # entry.payload  = "Log message"
  # entry.severity = :NOTICE
  # entry.resource.type = "capistrano_sample_app_v1"
  # entry.resource.labels[:module_id] = "default"
  # entry.resource.labels[:version_id] = "20160101t163030"
  # logging.write_entries entry

  # entries = logging.entries filter: 'resource.type = "capistrano_sample_app_v1"'
